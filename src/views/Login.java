...
public class Login extends JFrame {
	...
	public Login(UsuarioController usuarioController) {
		try {
		    ...
		    this.usuarioController = new UsuarioController(new UsuarioDAO(conn));
		} catch (SQLException e) {
		    e.printStackTrace();
		}
		setResizable(false);
		...
		btnRegistrar.addMouseListener(new MouseAdapter() {
		    ...
		    @Override
		    public void mouseClicked(MouseEvent e) {
		        RegistroUsuario registro = new RegistroUsuario(usuarioController); 
		        registro.setVisible(true);
		        dispose();
		    }
		});
		btnRegistrar.setBackground(SystemColor.textHighlight);
		btnRegistrar.setBounds(197, 431, 192, 44); 
		panel.add(btnRegistrar);
		btnRegistrar.setLayout(null);
		btnRegistrar.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));

		JLabel lblRegistrar = new JLabel("REGISTRAR");
		lblRegistrar.setBounds(0, 0, 192, 44);
	...
	private void Login() {
	    ...
	    if(usuarioController.verificarCredenciais(usuarioInserido, senhaInserida)) {
